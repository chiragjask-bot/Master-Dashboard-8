...
Private Function GetFieldMap() As Variant
    GetFieldMap = Array( _
        ...
        Array("Value (Rs. Crores)", "StocksTraded", "Value (Rs Crores)", "crores", False), _
        Array("Mkt Cap (Rs. Crores)", "StocksTraded", "Mkt Cap (Rs Crores)|Market Cap (Rs Crores)", "crores", False), _
